...
import HorizontalVerticalNav from "@/app-layouts/HorizontalVerticalNav/index.vue"
...
import { Layout, RouterTransition, type ThemeName, ThemeEnum } from "@/types/theme.d"
...
themeStore.setColor(ThemeEnum.Dark, "primary", "#185DCC")
themeStore.setColor(ThemeEnum.Light, "primary", "#185DCC")
themeStore.setLayout(Layout.HorizontalVerticalNav)
