...
export const useThemeStore = defineStore("theme", {
	...
	getters: {
		...
		themeOverrides(state): GlobalThemeOverrides {
			...
			return {
				...
				"Menu": {
					...
					"itemTextColorHoverHorizontal": "#2169dc",
					...
					"itemIconColorHorizontal": "#ffffff",
					"itemIconColorHoverHorizontal": "#2169dc",
					"itemIconColorActiveHorizontal": "#ffffff",
					"itemIconColorActiveHoverHorizontal": "#ffffff",
					...
					"itemColorHover": `${primary}80`,
					"itemColorActive": primary,
					"itemColorActiveHover": `${primary}80`,
					"itemColorActiveCollapsed": primary
				},
				Tag: {
				...
				Pagination: {
					itemColorActive: primary,
					itemColorActiveHover: `${primary}80`,
					itemColorDisabled: "#f0f0f0",
					itemColorDisabledHover: "#f0f0f0",
					itemColorHover: `${primary}80`,
					itemTextColorHover: "#ffffff",
					itemTextColorActive: "#ffffff",
					itemTextColorActiveHover: "#ffffff",
					itemTextColorDisabled: "#000000",
					itemTextColorDisabledHover: "#000000",
					itemTextColorActiveDisabled: "#000000",
					itemTextColorActiveDisabledHover: "#000000",
				},
			}
		},
		...
		navbarBackground(state): string {
			return state.colors[state.themeName].navbarBackground
		},
		...
		style(state): CSSStyleDeclaration {
			...
			const bgNavbar = this.navbarBackground
